...
bool WindowRenderer::Initialize(WindowContainer * pWindowContainer, HINSTANCE hInstance, std::string window_title, std::string window_class, int width, int height)
{
...
bool WindowRenderer::ProcessMessages() //Process loop
{
...
HWND WindowRenderer::GetHWND() const
{
	return this->handle;
}
...
LRESULT CALLBACK HandleMessageSetup(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) //Process's Func 
{
	switch (uMsg)
	{
	case WM_NCCREATE:
...
void WindowRenderer::RegisterWindowClass() //Setting  params
{
